<%@ page import="domain.TeachingPlan" %>
        ...
        <div class="detailContent">
            <div class="column_1">
                <section class="leftNav">
                    ...
                    <ul>
                        ...
                        <li class="current"><a href="../html/educationalDetail-4.jsp">授课计划</a></li>
            ...
            <div class="column_2 ">
                ...
                <!--    <embed src="../resource/面向对象分析与设计--授课计划.pdf" width="800" height="800"> -->
                    <c:if test="${!(empty plan.planURL)}">
                    <embed src="../${requestScope.plan.planURL}" width="800" height="800">
                    </c:if>
                </div>
            </div>
        </div>
