<%@ page import="domain.TeachingMeasure" %>
<%@ page import="service.TeachingMeasureService" %><%--
            ...
            <div class="column_1">
                <section class="leftNav">
                    ...
                    <ul>
                        ...
                        <li class="current"><a href="../html/educationalDetail-6.jsp">教学方法与手段</a></li>
                    </ul>
                </section>
            </div>
            <div class="column_2 ">
                ...
                <!--    <embed src="../resource/面向对象分析与设计--教学方法与手段.pdf" width="800" height="800"> -->
                    <c:if test="${!(empty measure.measureURL)}">
                    <embed src="../${requestScope.measure.measureURL}" width="800" height="800">
                    </c:if>
                </div>
            </div>
        </div>
