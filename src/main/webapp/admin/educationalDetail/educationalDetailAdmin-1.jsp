...
<div class="page-container">
    <div class="cl pd-5 bg-1 bk-gray mt-20">
	    <span class="l">
            ...
            <a class="btn btn-primary radius" data-title="添加教学大纲" data-href="<c:url value="/admin/educationalDetail/teachingGenrealAdd.jsp" />"
        ...
        <table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
            ...
            <c:forEach var="general" items="${requestScope.generals }">
                <tr class="text-c">
                    ...
                    <td>
                        <a href="<c:url value='/servlet/TeachingArrangementAdminServlet?type=useGeneral&generalId=${general.generalId}'/> ">使用</a>
                        <a href="<c:url value='/servlet/TeachingArrangementAdminServlet?type=delGeneral&generalId=${general.generalId}'/> ">删除</a>
                    </td>
                </tr>
            </c:forEach>
        </table>
