...
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"><a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">XXX</a>
            <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">ZCZ</a>
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        ...
        <dl id="menu-product5">
            ...
            <dd>
                <ul>
                    <li><a data-href="${pageContext.request.contextPath}/OpenCoursePlanServlet?method=showBack"
                           data-title="开课计划" href="javascript:void(0)">开课计划</a></li>
                    <li>
                        <a data-href="<c:url value='/ClassInfoServlet?method=Admin_LoadClassInfo&classInfoPageQuery=1'/>"
                           data-title="上课班级" href="javascript:void(0)">上课班级</a></li>
                    <li>
                        <a data-href="<c:url value='/ScoreServlet?method=Admin_LoadStudentEvalator&EvalatorpageQuery=1'/>"
                           data-title="学生成绩" href="javascript:void(0)">学生成绩</a></li>
                    <li>
                        <a data-href="<c:url value='/class_list_Servlet?method=Admin_LoadClassList&classListpageQuery=1'/>"
                           data-title="班级名册" href="javascript:void(0)">班级名册</a></li>
                    <li><a data-href="<c:url value='/HomeworkServlet?method=Admin_LoadHomework&HomeworkpageQuery=1'/>"
                           data-title="学生作业案例" href="javascript:void(0)">学生作业案例</a></li>
...
<dl id="menu-product9">
    ...
    <dd>
        <ul>
            ...
            <li><a data-href="_blank.html" data-title="校内学生评价"
                   href="<c:url value='/EvalatorServlet?method=Admin_LoadStudentEvalator&EvalatorpageQuery=1'/>">校内学生评价</a>
            </li>
            <li>
            ...
            <li><a data-href="_blank.html" data-title="教学评估及相关文件" href="javascript:void(0)">教学评估及相关文件</a></li>
        </ul>
    </dd>
</dl>
<dl id="menu-product">
